defmodule Sonos.Events do
  ...
  def group_rendering_control(doc) do
    doc = File.read!("/home/toad/bit/blah16.xml")
  ...
  def content_directory(doc) do
    doc |> xpath(~x"//e:propertyset"l,
      system_update_id: ~x"./e:property/SystemUpdateID/text()"i,
      container_update_ids: ~x"./e:property/ContainerUpdateIDs/text()"s,
      share_index_in_progress: ~x"./e:property/ShareIndexInProgress/text()"i,
  ...
  def last_change(doc) do
    ...
    |> xpath(~x"//Event/InstanceID",
      ...
      crossfade_mode: ~x"./CurrentCrossfadeMode/@val"i,
      number_of_tracks: ~x"./NumberOfTracks/@val"i,
      current_track: ~x"./CurrentTrack/@val"i,
      current_section: ~x"./CurrentSection/@val"i,
      ...
      direct_control_is_suspended: ~x"./r:DirectControlIsSuspended/@val"i,
      direct_control_account_id: ~x"./r:DirectControlAccountID/@val"s,
      direct_control_account_id: ~x"./r:DirectControlAccountID/@val"s,
      transport_status: ~x"./TransportStatus/@val"s,
      sleep_timer_generation: ~x"./r:SleepTimerGeneration/@val"i,
      alarm_running: ~x"./r:AlarmRunning/@val"i,
      snooze_running: ~x"./r:SnoozeRunning/@val"i,
      restart_pending: ~x"./r:RestartPending/@val"i
    )
  end
